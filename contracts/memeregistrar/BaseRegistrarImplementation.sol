...
contract BaseRegistrarImplementation is ERC721, IERC721Enumerable, IBaseRegistrar, Ownable {
    ...
    // The MNS registry
    MNS public mns;
    // The namehash of the TLD this registrar owns (eg, .meme)
    ...
    /**
     * v2.1.3 version of _isApprovedOrOwner which calls ownerOf(tokenId) and takes grace period into conmnseration instead of ERC721.ownerOf(tokenId);
    ...
    constructor(MNS _mns, bytes32 _baseNode) ERC721("MEME ID", "MNS") {
        mns = _mns;
        baseNode = _baseNode;
    }
    ...
    function transferFrom(
        ...
        mns.setSubnodeOwner(baseNode, bytes32(tokenId), to);
    }
